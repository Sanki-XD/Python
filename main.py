...
BOT_TOKEN = "6054008556:AAGpYJRfclSgQipVqJqF2-OmuVQuyul3TcI"
PAYMENT_CHANNEL = "@NixaWorld" #add payment channel here including the '@' sign
OWNER_ID = 5761513990 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@NixaWorld"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
